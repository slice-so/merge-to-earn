...
export const defaultDescription =
  "Merge to earn is a Github app to automate rewarding contributors with a slice of ownership over a project and its earnings, when pull requests are merged."
